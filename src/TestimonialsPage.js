...
class TestimonialsPage extends Component {
    render() {
        return(
            <div>
                <h1 style={{"textAlign": "center"} }>Testimonials Whiteboard</h1>
                <Grid container direction="column" justify="space-around" alignItems="center">
                    <Grid item sm={12} md={12} lg={12} container direction="row" alignItems="center" justify="space-around">
                        <Grid item sm={3} md={3} lg={3} className="testimonial-text">
                            <Paper>
                                <h1>Jo Ann, New York, NY</h1>
                                <p>
                        ...
                        <Grid item sm={4} md={4} lg={4} className="testimonial-text">
                            <Paper>
                                <h1>Sandra, Brooklyn, New York</h1>
                                <p>
                                    Thank you, thank you, thank you for making my trip to China a memorable one. I will always remember the wonderful people that I met (especially those in Group 3 and everyone on bus #1). It was an amazing experience, and a once in lifetime venture. I eagerly look forward to whatever travel plans you may arrange in the future. I'm sure you will keep me posted.
                                </p>
                            </Paper>
                        </Grid>
                    </Grid>
                    ...
                    <Grid item sm={12} md={12} lg={12} container direction="row" alignItems="center" justify="space-around">
                        <Grid item sm={3} md={3} lg={3} className="testimonial-text">
                            <Paper>
                                <h1>Steve, Chinese/Business Teacher, Provo, UT</h1>
                                <p>
                        ...
                        <Grid item sm={4} md={4} lg={4} className="testimonial-text">
                            <Paper>
                                <h1>Jeff /Linda, Westchester, NY</h1>
                                <p>
